        ...
        <div className="mt-16 grid grid-cols-1 gap-8 border-t border-gray-100 pt-16 md:grid-cols-4 lg:grid-cols-6">
          <div className="text-center sm:text-left">
            ...
            <ul className="mt-8 space-y-4 text-sm">
              <li>
                <a className="text-white">Company History</a>
              </li>

              <li>
                <a className="text-white">Meet the Team</a>
              </li>

              <li>
                <a className="text-white">Employee Handbook</a>
              </li>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="mt-8 space-y-4 text-sm">
              ...
              <li>
                <a className="text-white">Customer</a>
              </li>
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-white">STORES</p>

            <ul className="mt-8 space-y-4 text-sm">
              <li>
                <a className="text-white">Delhi</a>
              </li>

              <li>
                <a className="text-white">Mumbai</a>
              </li>

              <li>
                <a className="text-white">Noida</a>
              </li>

              <li>
                <a className="text-white">Chennai</a>
              </li>

              <li>
                <a className="text-white">Hydrabad</a>
              </li>
            </ul>
          </div>
          ...
          <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
            ...
            <div className="mx-auto mt-8 max-w-md sm:ms-0">
              <p className="text-start leading-relaxed text-white ltr:sm:text-left rtl:sm:text-right">
                Email us for more information and to know about our Company
              </p>
              ...
              <form className="mt-4">
                <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                  ...
                  <button
                    className="block rounded-full bg-green-600 px-8 py-3 font-medium text-white transition hover:bg-green-700"
                    type="submit"
                  >
                    SEND EMAIL
                  </button>
